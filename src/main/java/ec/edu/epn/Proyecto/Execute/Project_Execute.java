...
public class Project_Execute {
    public static void main(String[] args) {
        ...
        Producto producto1 = new Producto("001", "MORTADELA", 29.45, "SUPERMAXI", 40, "JURIS", "EMBUTIDO", "2021-07-08");
        Producto producto2 = new Producto("002", "CAFE", 10.3, "SUPERMAXI", 60, "NESTLE", "ENVASADOS", "2021-08-11");
        Producto producto3 = new Producto("003", " ATUN", 17.9, "SUPERMAXI", 56, "REAL", "ENLATADO", "2021-06-09");
        Producto producto4 = new Producto("004", "TOCINO", 23.56, "LA FAVORITA", 17, "JURIS", "EMBUTIDO", "2021-10-11");
        Producto producto5 = new Producto("005", "JAMON", 29.45, "SUPERMAXI", 40, "JURIS", "EMBUTIDO", "2021-11-08");
        Producto producto6 = new Producto("006", "ACEITE", 10.3, "SUPERMAXI", 10, "EL COCINERO", "EMBOTELLADO", "2021-08-11");
        Producto producto7 = new Producto("007", "CHOCOLATE", 17.9, "SUPERMAXI", 125, "NESTLE", "", "2021-07-09");
        Producto producto8 = new Producto("008", "MANTEQUILLA", 2.50, "LA FAVORITA", 20, "BONELLA", "LACTEO", "2021-07-11");
        Producto producto9 = new Producto("009", "TALLARIN", 29.45, "SUPERMAXI", 40, "DON VITORIO", "HARINA", "2021-08-08");
        Producto producto10 = new Producto("010", "NUECES", 10.3, "SUPERMAXI", 10, "SIN MARCA", "GRANOS", "2022-08-11");
        Producto producto11 = new Producto("011", " HARINA", 17.9, "SUPERMAXI", 56, "MARCA2", "HARINA", "2022-09-09");
        Producto producto12 = new Producto("012", "PAN", 0.08, "LA FAVORITA", 57, "HARINA YA", "HARINA", "2021-10-11");
